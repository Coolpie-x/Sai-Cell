...
const About = () => {
  ...
  return (
    <>
    <section id="about_us">
      <div className="lg:h-[45vw] md:h-[120vh] h-[72vh] bg-black w-full flex flex-col py-[5vw] lg:py-[5vw] items-center relative lg:gap-[1vw] gap-[2vw]">
        <h1 className="heading opacity-[1] lg:text-[6vw] font-semibold uppercase text-orange-200 text-[12vw]">About US</h1>
        <p className="para lg:w-[90%] w-[80%] h-[20vw] opacity-[.8] text-orange-100 text-center lg:text-[2vw] text-[4.4vw] relative font-sans ">
